...
class Detalle_Compra(models.Model):
	...
	folio_compra_pk_fk = models.ForeingKey(Proveedor, null=True, blank=False, on_delete=models.CASCADE)
	id_material_pk_fk = models.ForeingKey(Proveedor, null=True, blank=False, on_delete=models.CASCADE)
